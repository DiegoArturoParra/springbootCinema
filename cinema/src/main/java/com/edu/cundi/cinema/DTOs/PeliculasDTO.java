...
public class PeliculasDTO {
        ...
        private static Autor autorTerminator = new Autor("james", "cameron", 67);

        static {
                listapeliculas.add(new Pelicula(1, "The Terminator", autorTerminator,
                ...
                listapeliculas.add(new Pelicula(2, "El juicio final", autorTerminator,
